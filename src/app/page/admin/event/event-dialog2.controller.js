(function() {
    ...
    function EventDialog2Controller($scope, $mdDialog, $filter, triTheming, dialogData, event, edit, MentorshipService, AdminService, SignUpService) {
        ...
        function okClick() {
            ...
            AdminService.updateActivity(vm.title, vm.number, vm.startDate, vm.endDate, vm.content, vm.location, vm.event.meetingID, vm.school)
            copy();
            $mdDialog.cancel();
        }
