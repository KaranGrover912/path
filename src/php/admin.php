	...
	if (!$dbconn) {
		...
		switch ($action) {
            ...
            case 'createActivity':
				...
				$sql = "INSERT INTO Activity (subject,numOfPe,startDate,endDate,content,location, schoolID) VALUES ('$subject','$numOfPe','$startDate', '$endDate', '$content', '$location', '$school')";
				$result = mysqli_query($dbconn, $sql);
                break; 
            case 'getActivity':
            ...
            case 'updateActivity':
				...
				$school = $_GET['school'];
				$id = $_GET['id'];
                $sql = "UPDATE Activity SET subject = '$subject' ,numOfPe = '$numOfPe' ,startDate = '$startDate' ,endDate = '$endDate', content = '$content', location = '$location', schoolID = '$school' WHERE activityID = '$id'";
				$result = mysqli_query($dbconn, $sql);
                break;
            case 'deleteActivity':
                $id = $_GET['id'];
